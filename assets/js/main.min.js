$(document).ready(function () {
  ...
  for (var i = 0; i < liItems.length; i++) {
    liItems[i].onclick = function () {
      ...
      // set hieuej uwng aos trên top

      section = document.querySelector(classNameOfSection);
      listAosInit = section.querySelectorAll(".aos-init");
      // console.log(listAosInit);
      listAosInit.forEach((element) => {
    ...
    if (!isCreated) {
      ...
      if ($(".mySwiper").length > 0) {
        swiper = new Swiper(".mySwiper", {
          ...
          on: {
            transitionStart: async function () {
              // section = document.querySelector("#s_" + swiper.activeIndex);
              // listAosInit = section.querySelectorAll(".aos-init");
              // // console.log(listAosInit);
              // listAosInit.forEach((element) => {
              //   element.classList.remove("aos-animate");
...
if (!checkIsMobileToUseControlBook()) {
  ...
  myDiv.addEventListener("mousedown", function (event) {
    ...
    const grabCursor = document.querySelector("#mybook");
    grabCursor.style.cursor = "grabbing";
  });
...
groupIconHome = document.querySelector(".img_icon");

groupIconHome.onmouseover = () => {
  document.querySelector(".img_icon img").src =
    "assets/images/arrow-back-active.png";
};

groupIconHome.onmouseout = () => {
  document.querySelector(".img_icon img").src = "assets/images/arrow-back.png";
};
